...
Using eq.\ref{eq:diff} $V_{1(ref)}$ is solved for simultaneously by setting the equations for the scenario when the battery voltage is 7.5V and 5.7V.
